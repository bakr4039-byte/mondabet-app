...
@Component({
      ...
      <mat-card style="width:360px">
        ...
        <mat-card-content>
          <form [formGroup]="form" (ngSubmit)="submit()">
            ...
            <mat-form-field appearance="outline" style="width:100%">
              <mat-label>{{ 'auth.tenant_code' | translate }}</mat-label>
  ...
  `,
  styles: [`.login-wrapper { display:flex; justify-content:center; align-items:center; height:100vh; background:#f5f5f5; }`],
})
