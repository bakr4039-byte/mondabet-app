...
@Component({
  selector: 'app-shell',
  standalone: true,
  imports: [RouterOutlet, RouterLink, MatToolbarModule, MatSidenavModule, MatListModule, MatIconModule, MatButtonModule, MatMenuModule, TranslateModule],
  template: `
    <mat-sidenav-container style="height:100vh">
      <mat-sidenav mode="side" opened style="width:220px">
        <mat-toolbar color="primary" style="font-size:16px">{{ 'app.title' | translate }}</mat-toolbar>
        <mat-nav-list>
          <a mat-list-item routerLink="/employees">
            <mat-icon matListItemIcon>people</mat-icon>
            <span matListItemTitle>{{ 'nav.employees' | translate }}</span>
          </a>
          <a mat-list-item routerLink="/leaves">
            <mat-icon matListItemIcon>event_available</mat-icon>
            <span matListItemTitle>{{ 'nav.leaves' | translate }}</span>
          </a>
          <a mat-list-item routerLink="/workflow">
            <mat-icon matListItemIcon>account_tree</mat-icon>
            <span matListItemTitle>{{ 'nav.workflow' | translate }}</span>
          </a>
      ...
      <mat-sidenav-content>
        ...
        <div style="padding:24px"><router-outlet /></div>
      </mat-sidenav-content>
